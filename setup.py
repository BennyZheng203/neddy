...
setup(
    ...
    url='https://github.com/BennyZheng203/neddy',
    download_url='https://github.com/BennyZheng203/neddy/archive/v%(__version__)s.zip' % locals(),
    author='Benny Zheng',
    author_email='bennyzheng203@example.com',
    license='MIT',
